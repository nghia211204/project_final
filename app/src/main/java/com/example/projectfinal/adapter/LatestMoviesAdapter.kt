...
class LatestMoviesAdapter(
    ...
    private val onBookmarkChanged: ((Int) -> Unit)? = null
    ...
    inner class MovieViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        private val overviewText: TextView = view.findViewById(R.id.tvOverview)
        private val genreText: TextView = view.findViewById(R.id.tvGenre)
        ...
        fun bind(movie: Movie, listener: OnMovieClickListener) {
            ...
            genreText.text = "Action, Comedy, Crime"
            ...
            bookmarkIcon.setOnClickListener {
                if (AuthManager.isUserLoggedIn()) {
                    if (BookmarkManager.isBookmarked(movie.id)) {
                        ...
                        onBookmarkChanged?.invoke(movie.id)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MovieViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_movie_latest, parent, false)
